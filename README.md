...
Estado: semana 0 completada (ver `docs/semana-0-derisking.md`). Ingesta, bronze y silver corriendo, orquestados por Airflow (`orchestration/README.md`). Fuentes cerradas de punta a punta, en local y en AWS: `produccion_pozo` y `fractura` (perfil de cada una en `docs/fuentes/`). Decisiones de arquitectura en `docs/adr/`.
